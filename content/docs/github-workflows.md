...
## `kind.yml` - 📦 Assisted Migration E2E (end-to-end) Test Suite

### 🔍 Overview

This repository includes a powerful **End-to-End (E2E) test suite** designed to validate the **Assisted Migration** system.   
