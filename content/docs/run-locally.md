...
This guide provides instructions for setting up and running the Assisted Migration locally for development purposes.
...
## Run the Assisted Migration API locally

Follow these steps to get the Assisted Migration running locally:
...
Start the Assisted Migration API server:
...
## Use the Assisted Migration API

There are different ways to use the Assisted Migration API:
...
## Run the Assisted Migration Agent locally
...
Start the Assisted Migration Agent with the configuration file:
