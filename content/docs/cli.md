...
```bash
$ planner -h
planner controls the Assisted Migration service.
...
The e2e command is used to run the end-to-end (E2E) test suite for the Assisted Migration. This is primarily intended for development and QA purposes,  
